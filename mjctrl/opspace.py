...
impedance_pos = np.asarray([120.0, 120.0, 120.0])  # [N/m]
impedance_ori = np.asarray([75.0, 75.0, 75.0])  # [Nm/rad]

# Joint impedance control gains.
Kp_null = np.asarray([75.0, 75.0, 50.0, 50.0, 40.0, 50.0, 150.0])
...
def main() -> None:
    ...
    with mujoco.viewer.launch_passive(
        ...
        while viewer.is_running():
            ...
            print(data.site(site_id).xmat.shape)
